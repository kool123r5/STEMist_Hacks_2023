...
train_ds = keras.utils.image_dataset_from_directory(
    directory='/Users/kushalb/Documents/VSCode/NeuralNetworkForSTEMistHacks/trainData',
    labels='inferred',
    label_mode='categorical',
    batch_size=32,
    image_size=(515, 389))
validation_ds = keras.utils.image_dataset_from_directory(
    directory='/Users/kushalb/Documents/VSCode/NeuralNetworkForSTEMistHacks/testData',
    labels='inferred',
    label_mode='categorical',
    batch_size=32,
    image_size=(515, 389))
